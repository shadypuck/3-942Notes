...
\section{Phase Behavior and Microphase Separation}
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Recall from Lecture 1.3 that the entropy $S$ of a polymer chain without excluded volume effects (as in the melt state) is given by
            \begin{equation*}
                S = -\frac{3\kB R^2}{2Na^2}
            \end{equation*}
            \item Recall from Lecture 2.1 that the mixing energy per site $\Delta H_M/X_0$ of components A and B may be related to other parameters by
            \begin{equation*}
            ...
            \begin{itemize}
                \item In both State 0 and State 2, like chains will interact with each other enthalpically via at least London dispersion forces. Recall that this is how we got the equations $H_i=zX_i\varepsilon_{ii}/2$ in Lecture 2.1.
    ...
    \begin{itemize}
        \item What is the energy or enthalpy? If we need to take excluded volume into account, then from Lecture 1.3, 
        \begin{equation*}
