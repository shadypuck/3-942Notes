...
\begin{itemize}
    ...
    \begin{itemize}
        \item What is the energy or enthalpy? If we need to take excluded volume into account, then
        \begin{equation*}
            \Delta H \propto vc^2\cdot HD^2 = \frac{vN^2}{HD^2}
        \end{equation*}
        \begin{itemize}
            ...
            \item Note the similarity between this term and the Virial expansion's binary term from Lecture 1.3.
        \end{itemize}
