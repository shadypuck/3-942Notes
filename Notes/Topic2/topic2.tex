...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Solubility parameter}: A numerical estimate of the degree of interaction between materials. \emph{Units} \textbf{\si[text-family-to-math]{\raiseto{1/2}\mega\pascal}}. \emph{Denoted by} $\bm{\delta}$. \emph{Given by}
    \begin{equation*}
        \delta := \sqrt{\text{CED}}
    \end{equation*}
    \begin{itemize}
