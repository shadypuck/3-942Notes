...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{align*}
        where $\phi_i$ denots the \textbf{volume fraction} of spaces occupied by species $i$.
    \end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item It follows that if $\chi<1/2$, the chemical potential $\mu_1$ will be less than that of the standard, unmixed state $\mu_1^\circ$. Therefore, to lower chemical potential, hence everything will want to mix.
            \end{itemize}
    ...
    \end{itemize}
    \item Does slide 33 imply that it is harder to mix small amounts of high molecular weight polymer into a solvent than it is to mix large amounts of said polymer into a solvent?? Maybe it's something to do with the "solvent" becoming more of a swelling additive to the polymer than vice versa?
...
\begin{itemize}
    ...
    \item How does the drawing of tangent lines work for solutions that don't start at $\phi_2=0.5$??
    \begin{itemize}
        \item The new free energy is the average of the two "sub" solutions, and can be visually represented as the midpoint of the line connecting the points between the two new solutions.
        \item When at a spinodal point, phase separating further by just a bit will result in a line with midpoint \emph{exactly} on the spinodal inflection point, and the system will eventually relax back.
        \item There is a good explanation of common tangent construction on \textcite[294-95]{bib:HiemenzLodge}. It appears that this is not part of class material, but would be very helpful in understanding it.
    \end{itemize}
