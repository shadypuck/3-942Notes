...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Let $Q_\text{macro}$ denote the charge of the gel \emph{after} the one charge leaves it, and let $R$ denote the radius of the gel.
            \begin{itemize}
                \item Since a single positive charge is leaving the gel (as in Figure \ref{fig:gelChargeNeg}), the gel will have a net negative charge afterwards. In other words, $Q_\text{macro}$ is equal to the opposite of the charge on the one leaving charge.
            \end{itemize}
            \item Once the single charge leaves, what we essentially have is two charges of equal magnitude separated by a distance equal to (just over) the radius of the gel. Symbolically,
            \begin{equation*}
                U_\text{elec} = \frac{Q_\text{macro}^2}{4\pi\varepsilon R}
            \end{equation*}
            \item Dividing through by $\kB T$, we obtain
            \begin{equation*}
                \frac{U_\text{elec}}{\kB T} = \frac{Q_\text{macro}^2}{4\pi\varepsilon R\kB T} = \frac{\lB}{R}
            \end{equation*}
            \item If $Q_\text{macro}\cdot\lB/R>1$, then "no" charges will leave the gel?? So $Q_\text{macro}>R/\lB$.
        \end{itemize}
        \item Let $Q_\text{tot}$ denote the original number of charges in the gel. What is the ratio $Q_\text{macro}/Q_\text{tot}$?
        \begin{itemize}
            \item Let $v$ denote the volume of a monomer (assumed to be the same for polymer and solvent). Additionally, let's expand our definition of $Q_\text{macro}$ to mean the total charge of the gel after many potential departures.
            ...
            \item Multiplying by $V/V=1$ and simplify using $V_0/V=1/\phi_2$ ($V_0/V=\phi_2$, as defined last lecture??), we obtain
            \begin{equation*}
                Q_\text{tot} = \frac{fV_0}{v}\cdot\frac{V}{V}
                = \frac{fV}{v\phi_2}
            \end{equation*}
            \item This combined with the fact that $Q_\text{macro}\propto\lB/R$ yields
            \begin{equation*}
                \frac{Q_\text{macro}}{Q_\text{tot}} = \frac{R/\lB}{fV/v\phi_2}
                \propto \frac{R/\lB}{fR^3/v\phi_2}
                = \frac{\phi_2v}{f\lB R^2}
            \end{equation*}
    ...
    \begin{itemize}
        ...
        \begin{equation*}
            \left( \chi-\frac{1}{2} \right)\phi_2^2 = -\frac{\rho\hat{V}_1}{M_x}\left( \phi_2^{1/3}-\frac{\phi_2}{2}-\frac{fN_x\phi_2}{2} \right)
        \end{equation*}
        \begin{itemize}
            \item Is $N_x=N_\text{counterions}$?? Do we need to know anything else about this derivation?
