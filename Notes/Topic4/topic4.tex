    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{equation*}
                ...
                = \frac{3\kB T}{N}
            \end{equation*}
            where $N$ is the average degree of polymerization per subchain (i.e., the average number of monomers between crosslinks)?? Pretty sure $\rho N_\text{A}/M_x=z/V$, not $1/N$.
        \end{itemize}
    \end{itemize}
